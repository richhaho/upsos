...
return [
    ...
    */
    ...
    'templates' => [
        ...
        'facebook' => '<a href=":url" class="social-button:class":id:title:rel><i class="fa-brands fa-square-facebook"></i></a>',
        'hackernews' => '<a href=":url" class="social-button:class":id:title:rel><span class="fab fa-hacker-news"></span></a>',
        'linkedin' => '<a href=":url" class="social-button:class":id:title:rel><i class="fa-brands fa-linkedin"></i></a>',
        'mailto' => '<a href=":url" class="social-button:class":id:title:rel><span class="fas fa-envelope"></span></a>',
        'pinterest' => '<a href=":url" class="social-button:class":id:title:rel><i class="fa-brands fa-pinterest"></i></a>',
        ...
        'telegram' => '<a href=":url" class="social-button:class":id:title:rel target="_blank"><i class="fa-brands fa-telegram"></i></a>',
        'twitter' => '<a href=":url" class="social-button:class":id:title:rel><i class="fa-brands fa-x-twitter"></i></a>',
        'vkontakte' => '<a href=":url" class="social-button:class":id:title:rel><span class="fab fa-vk"></span></a>',
        'whatsapp' => '<a href=":url" class="social-button:class":id:title:rel target="_blank"><i class="fa-brands fa-square-whatsapp"></i></a>',
