            ...
            <div class="row menu-builder">
               <div class="col-lg-12">
                  <ul class="list-group">
                     ...
                     <li class="list-group-item d-flex justify-content-between">
                        <span class="menu-items">{{ __('All Jobs') }}</span>
                        <a data-title="{{ __('All Jobs') }}" data-dropdown="no" data-href="/all/jobs" data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                     </li>
                     <li class="list-group-item d-flex justify-content-between">
                        <span class="menu-items">{{ __('All Services') }}</span>
                        <a data-title="{{ __('All Services') }}" data-dropdown="no" data-href="/all/services" data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                     </li>
