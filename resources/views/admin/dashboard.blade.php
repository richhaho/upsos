          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                ...
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ showAdminPrice($depositAmount) }} </div>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                ...
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ showAdminPrice($withdrawAmount) }} </div>
              </div>
              <div class="col-auto">
                <i class="fas fa-dollar-sign fa-2x text-success"></i>
              </div>
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                ...
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ showAdminPrice($withdrawChargeAmount) }} </div>
              </div>
              <div class="col-auto">
                <i class="fas fa-dollar-sign fa-2x text-success"></i>
              </div>
