...
<div class="card">
  ...
  <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.feature.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{route('admin.feature.create')}}">{{ __('Add New ') }}</a></li>
  </ol>
  </div>
</div>
  ...
  <div class="col-md-10">
    <div class="card mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">{{ __('Choos Us Form') }}</h6>
      </div>
