...
<div class="row justify-content-center mt-3">
        ...
        <form class="geniusform" action="{{route('admin.role.update',$data->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Manage Plan" {{ $data->sectionCheck('Manage Plan') ? 'checked' : '' }} class="custom-control-input" id="manage_plan">
                  <label class="custom-control-label" for="manage_plan">{{__('All Plan')}}</label>
                  </div>
              </div>
            </div>
			...
			<div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Seller Subscription" {{ $data->sectionCheck('Seller Subscription') ? 'checked' : '' }} class="custom-control-input" id="seller_subscription">
			...
			<div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
				  <input type="checkbox" name="section[]" value="Services" {{ $data->sectionCheck('Services') ? 'checked' : '' }} class="custom-control-input" id="services">
                  <label class="custom-control-label" for="services">{{__('Services')}}</label>
                  </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="All Job" {{ $data->sectionCheck('All Job') ? 'checked' : '' }} class="custom-control-input" id="all_job">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="All Orders" {{ $data->sectionCheck('All Orders') ? 'checked' : '' }} class="custom-control-input" id="all_order">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Manage Customers" {{ $data->sectionCheck('Manage Customers') ? 'checked' : '' }} class="custom-control-input" id="manage_customer">
 ...
 <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="section[]" value="Withdraws" {{ $data->sectionCheck('Withdraws') ? 'checked' : '' }} class="custom-control-input" id="withdraws">
