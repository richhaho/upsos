...
<div class="card">
	...
	<h5 class=" mb-0 text-gray-800 pl-3">{{ __('How It Works') }}</h5>
	<ol class="breadcrumb">
		...
		<div class="card-body">
		  ...
		  <form class="geniusform" action="{{route('admin.ps.update')}}" method="POST" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" id="hero_subtitle" name="start_text"  placeholder="{{ __('Enter Subtitle') }}" value="{{ $data->start_text }}" required>
			  </div>
			  <div class="form-group">
