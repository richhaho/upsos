					...
					<tr>
                        ...
                        <td data-label="@lang('Order Complete Request')">
							<div>
								...
								<button id="completed" type="button"  class="btn btn-primary btn-sm" data-bs-toggle="modal" data-val={{ route('buyer.job.order.complete', $data->id) }} data-bs-target="#completemodal">
									@lang('Approve')
								</button>
						...
						<td data-label="@lang('Actions')">
                            ...
                            <a href="{{ route('front.jobdetails',$data->job->job_slug) }}" class="icon-btn btn btn-primary btn-sm" data-original-title="@lang('View')">
                            <i class="fas fa-eye"></i>
                            </a>

                            <a href="{{ route('buyer.job.conversation',$data->job->id) }}" class="icon-btn btn btn-success btn-sm" data-original-title="@lang('conversasion')">
								<i class="fas fa-comments"></i>
							</a>

							<a href="{{ route('buyer.job.order.details',$data->id) }}" class="icon-btn btn btn-info btn-sm" data-original-title="@lang('Details')">
      ...
      <div class="modal-content">
        ...
        <form id="request-form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                @lang('Are you sure to change status? Once you done you can not revert this !!')
            </div>
