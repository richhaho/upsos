...
<div class="dashboard--content-item">
    <div class="card p-3 default--card">
        <form action="{{ auth::user()->is_seller == 1 ? route('user.transaction') :  route('buyer.transaction') }}" method="get">
            <div class="row">
                <div class="col-md-4">
    ...
    <div class="table-responsive table--mobile-lg">
        <table class="table bg--body">
            ...
            <tbody>
                ...
                @else @foreach($transactions as $key=>$data) @php $from = App\Models\User::where('id',$data->user_id)->first(); @endphp
                <tr>
