                    ...
                    <form id="request-form" action="{{ route('user.store.attribute',$service->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if ($service->is_service_online == 0)
                            ...
                            <div class="included-package">
                                <div class=" mt-5">
                                    <h4>@lang('What is included in basic package. (Required)')</h4>
									<label class="service-form-label">&#x1F6C8; @lang('Specify what is included in basic package with the cost of each work, quantity or hours.')</label>
                                ...
                                <div class="input my-4 row">
                                    ...
                                    <div class="col-md-2 mt-5">
                                        <label for="#duration">@lang('Qunatity / Hours')</label>
                        ...
                        <div class="included-package">
                            <div class=" mt-5">
                                <h4>@lang('Benefits of the package. (Optional)')</h4>
                            </div>
                            <div class="input my-4 row">
                                <div class="col-md-12">
                        ...
                        <div class="included-package">
                            <div class=" mt-5">
                                <h4>@lang('Additional product or service. (Optional)')</h4>
								<label class="service-form-label">&#x1F6C8; @lang('An additional product or service that can be added to an order by the buyer if desired.')</label>
                        ...
                        <div class="included-package">
                            <div class=" mt-5">
                                <h4>@lang('Answers to Frequently Asked Questions. (Optional)')</h4>
<label class="service-form-label">&#x1F6C8; @lang('Questions that the buyer may have and answers to them.')</label>
                            </div>
                            <div class="input my-4 row">
                                <div class="col-md-6">
                                    <input id="title" name="faq_title[]" type="text" class="form-control" placeholder="Question" >
                                </div>

                                <div class="col-md-6">
                                    <textarea class="form-control nic-edit" name="faq_detail[]" id="" cols="30" rows="5" placeholder="Answer"></textarea>
                                </div>
                            </div>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            <div class="col-md-1 mt-5">
                <a href="#" class="online-remove cmn-remove btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
            </div>
        </div>`;
            }
            ...
            $('#offline').on('click', '.offline-remove', function(e) {
                e.preventDefault();
                $(this).closest('.input').remove();
            });
