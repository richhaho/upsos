                          ...
                          <div class="chat__msg">
                              ...
                              <div class="chat__msg-body">
                                ...
                                <div class="chat__msg-footer">
                                    <form action="{{ auth::user()->is_seller == 1 ? route('user.message.conversation',$data->id) : route('buyer.message.conversation',$data->id) }}" class="send__msg" method="post" enctype="multipart/form-data">
                                        @csrf
