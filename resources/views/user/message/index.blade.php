...
<div class="dashboard--content-item">
  <div class="d-flex justify-content-between">
    <a href="{{ auth::user()->is_seller == 1 ? route('user.message.create') : route('buyer.message.create') }}" class="ms-auto btn btn-primary mb-2">
      @lang('Create Ticket')
    </a>
  </div>
            ...
            @foreach($convs as $conv)
              <tr class="conv">
                ...
                <td data-label="{{ __('Action') }}">
                  <div class="d-flex">
                    <a href="{{ auth::user()->is_seller == 1 ? route('user.message.show',$conv->id) : route('buyer.message.show',$conv->id)}}" class="link view me-1 btn d-block btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                  </div>
                </td>
