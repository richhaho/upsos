    ...
    <div id="enableModal" class="modal modal-blur fade" role="dialog" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog ">
            ...
            <div class="modal-content ">
                ...
                <form action="{{ auth::user()->is_seller == 1 ? route('user.createTwoFactor') : route('buyer.createTwoFactor') }}" method="POST">
                    @csrf
    ...
    <div id="disableModal" class="modal modal-blur fade" role="dialog" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="{{ auth::user()->is_seller == 1 ? route('user.disableTwoFactor') : route('buyer.disableTwoFactor') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" class="form-control" name="code" placeholder="@lang('Enter Google Authenticator Code')">
