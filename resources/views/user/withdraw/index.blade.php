...
<div class="breadcrumb-area">
  ...
  <ul class="breadcrumb">
      <li>
          <a href="{{ auth::user()->is_seller == 1 ? route('user.dashboard') : route('buyer.dashboard') }}">@lang('Dashboard')</a>
      </li>
      <li>
          @lang('Withdraw')
      </li>
                    ...
                    <tr>
                        ...
                        <td data-label="Options">
                          <div class="text-center">
                              <a href="{{ auth::user()->is_seller == 1 ? route('user.withdraw.details',$data->id) : route('buyer.withdraw.details',$data->id) }}" class="btn btn--base text--dark btn-sm">
...
<div class="modal fade" id="withdraw-modal" aria-modal="true" role="dialog">
  <div class="modal-dialog">
      <div class="modal-content">
        <form action="{{ auth::user()->is_seller == 1 ? route('user.withdraw.request') : route('buyer.withdraw.request')}}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="modal-body p-4">
              ...
              <div class="pt-3 pb-4">
                ...
                <input type="text" name="withdraw_wallet" class="form-group-input form-control form--control bg--section" placeholder="0.00" id="withdraw_wallet" value="Main Wallet" disabled>
