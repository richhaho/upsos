...
use App\Http\Controllers\Checkout\WalletController;
...
Route::post('/free-submit', [ManualController::class,'free'])->name('checkout.free.submit');
...
Route::get('/molly-notify', [MollieController::class,'notify'])->name('checkout.molly.notify');
...
Route::post('wallet/plan/submit', [WalletController::class,'store'])->name('wallet.plan.submit');