...
class MollieController extends Controller
{
    ...
    public function notify(Request $request){
        ...
        if($payment->status == 'paid'){
            ...
            return redirect()->route('user.invest.plans')->with('message','Invest successfully complete.');
        }
        else {
            return redirect()->route('user.invest.plans')->with('warning','Something went wrong!');
        }
