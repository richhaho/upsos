...
class PaytmController extends Controller
{
    ...
    public function store(Request $request){
        ...
        {
            Toastr::error('Please Select INR Currency For Paytm.');
        ...
        $item_name = $settings->title."Service Order";
        $item_number = Str::random(12);
        $item_amount =  $amountToAdd;
        $addionalData = ['item_number'=>$item_number,'payment_method'=>'paytm'];;
    ...
    public function handlePaytmRequest( $transaction_id, $amount) {
        ...
        $paramList["CALLBACK_URL"] = route('service.paytm.notify');
