...
class AuthorizeController extends Controller
{
    public function store(Request $request){
            ...
            if ($response != null) {
                if ($response->getMessages()->getResultCode() == "Ok") {
                    ...
                    if ($tresponse != null && $tresponse->getMessages() != null) {
                        ...
                        {
                            return redirect()->route('buyer.deposit.create')->with('success','Deposit amount '.$request->amount.' ('.$request->currency_code.') successfully!');
                        }
                        ...
                        return redirect()->route('user.deposit.create')->with('unsuccess', 'Payment Failed.');
                            ...
                            return redirect()->route('buyer.deposit.create')->with('unsuccess', 'Payment Failed.');
                        }
                    }
                } else {
                    if(Auth::user()->is_seller == 1)
        ...
        return redirect()->route('user.deposit.create')->with('unsuccess', 'Invalid Payment Details.');
            ...
            return redirect()->route('buyer.deposit.create')->with('unsuccess', 'Invalid Payment Details.');
        }
    }
}
