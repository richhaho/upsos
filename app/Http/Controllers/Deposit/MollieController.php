    ...
    public function notify(Request $request){
        ...
        if($payment->status == 'paid'){
            ...
            if(Auth::user()->is_seller == 1){
                ...
                return redirect()->route('buyer.deposit.create')->with('success','Deposit amount ('.$input['amount'].') successfully!');
            }
            ...
            if(Auth::user()->is_seller == 1){
                ...
                return redirect()->route('buyer.deposit.create')->with('warning','Something Went wrong!');
            }
