...
class PaytmController extends Controller
{
    ...
    public function handlePaytmRequest( $transaction_id, $amount) {
        ...
        $paramList["CALLBACK_URL"] = auth()->user()->is_seller ==1 ? route('user.deposit.paytm.notify') : route('buyer.deposit.paytm.notify');
    ...
    public function paytmCallback( Request $request ) {
        ...
        if ( 'TXN_SUCCESS' === $request['STATUS'] ) {
            ...
            if(Auth::user()->is_seller == 1){
                ...
                return redirect()->route('buyer.deposit.create')->with('success','Deposit amount '.$input['amount'].' ('.$input['currency_code'].') successfully!');
            }
            ...
            if(Auth::user()->is_seller == 1){
                ...
                return redirect()->route('buyer.deposit.create')->with('unsuccess', 'Payment Cancelled.');
            }
