...
class InstamojoController extends Controller
{
    public function store(Request $request)
    {
        ...
        $cancel_url =auth()->user()->is_seller == 1 ? route('user.deposit.paypal.cancel'): route('buyer.deposit.paypal.cancel');
        $notify_url = auth()->user()->is_seller == 1 ?  route('user.deposit.instamojo.notify'): route('buyer.deposit.instamojo.notify');
    ...
    public function notify(Request $request)
    {
        ...
        if(Auth::user()->is_seller == 1){
            ...
            return redirect()->route('buyer.deposit.create')->with('unsuccess','Something Went wrong!');
        }
    }
}
