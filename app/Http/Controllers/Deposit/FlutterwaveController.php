...
class FlutterwaveController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $redirect_url = auth()->user()->is_seller ==1 ? route('user.deposit.flutter.notify') : route('buyer.deposit.flutter.notify');
        $payment_plan = "";
            ...
            if ($resp['status'] == "success") {
              ...
              if (($chargeResponsecode == "00" || $chargeResponsecode == "0") && ($paymentStatus == "successful")) {
                  ...
                  if(Auth::user()->is_seller == 1){
                    ...
                    return redirect()->route('buyer.deposit.create')->with('success','Deposit amount '.$deposit_data['amount'].' ('.$deposit_data['currency_code'].') successfully!');
                  }
                ...
                return redirect()->route('user.deposit.create')->with('error','Something went wrong!');
                  ...
                  return redirect()->route('buyer.deposit.create')->with('error','Something went wrong!');
                }
              }
