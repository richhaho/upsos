...
class RazorpayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $notify_url = auth()->user()->is_seller == 1 ? route('user.deposit.razorpay.notify'): route('buyer.deposit.razorpay.notify');
    ...
    public function notify(Request $request)
    {
        ...
        if ($success === true){
            ...
            {
                 return redirect()->route('buyer.dashboard')->with('success','Deposit amount '.$input['amount'].' ('.$input['currency_code'].') successfully!');
            }
        }
