    ...
    function getRefundArray2Str($arrayList) {
        ...
        public function paytmCallback( Request $request ) {
            ...
            if ( 'TXN_SUCCESS' === $request['STATUS'] ) {
                ...
                $order = UserSubscription::where('transaction_no',$order_number)->where('payment_status','pending')->first();
                ...
                return redirect()->route('user.invest.plans')->with('warning','Payment Cancelled!');
            }
        }
}
